// depict_types.h — shared data types passed between sensing modules and fusion.
#pragma once
...
// Candidate polymer classes. Keep in sync with the trained model's label order
// (see software/ml/models/labels.txt).
